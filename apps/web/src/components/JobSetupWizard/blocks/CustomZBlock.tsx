...
/**
 * Custom G-code block for job setup or one-off probe. Runs the method's custom G-code, then complete.
 */
export function CustomZBlock({
  methods,
  context,
  onComplete,
  onError,
  ...
  return (
    <SetupBlockLayout
      subtitle={t('Run your custom G-code to set work zero.')}
      nextButton={{
        onClick: onComplete,
