 ...
 */
export function ManualXYBlock({ context, onComplete, footerLeftExtra, footerRightExtra }: SetupBlockProps) {
        ...
        <div className="space-y-2">
          ...
          {!isXZero && !isYZero && (
            <p className="text-xs text-muted-foreground">
              {t('Set both X and Y to zero in the DRO for work zero, or press Next to continue.')}
            </p>
          )}
        </div>
      </div>
